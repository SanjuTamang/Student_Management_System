...
include 'connection.php' ;
    ...
    mysqli_query($conn,"INSERT INTO students VALUES('$studentname','$nickname','$fathername','$mothername','$studentmobile','$parentsmobile','$youremail','$parentsemail','$aadharno','$parentsaadharno','$temaddress','$paraddress','$tenthboardname','$twelvethboardname','$tenthmarks','$twelvemarks','$qulification','$admissioncourse')");
...
<link rel="stylesheet" href="./css/admission.css">
   <title>Admission Form |NUBH Admission Form</title>
</head>
<body>
            ...
            <div class="registerMainContainer">
               ...
               <div class="registerLeftBox registerBox" method="post">
                     ...
                     <div class="formGroup">
                        ...
                        <input type="number" placeholder="Enter Semester" name="semester" id="semester" required><br><br>
                     </div>
               ...
               <div class="registerRightBox registerBox">
                  ...
                  <div class="formGroup">
                        ...
                        <input type="text" placeholder="Section" name="Section" id="Section" required><br><br>
                     </div>
               </div>
                  <div class="formGroup">
                        <label for="Section">you agree all <a href="../client/Components/t&c.php">term & condition by click</a> </label><br>
